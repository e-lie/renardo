...
synth = library.get_resource(0, SCCodeType.INSTRUMENT, "bass", "simple_bass")
if synth:
...
effect = library.get_resource(0, SCCodeType.EFFECT, "reverb", "plate_reverb")
if effect:
...
if bank:
    bass_category = bank.get_category(SCCodeType.INSTRUMENT, "bass")
    if bass_category:
