...
# Puede utilizar sus propias samples simplemente soltando archivos de audio en los directorios de muestras existentes de FoxDot.
# Estos se encuentran en el directorio 'snd' en la root de la instalación de FoxDot
# (por ejemplo, 'C:\Python27\Lib\site-packages\FoxDot\snd').
...
# Si tienes una carpeta llena de samples que te gustaría usar en FoxDot, puedes llamar a loop() con la ruta completa al sample.
...
# Si va a utilizar muchas muestras de una carpeta, puede añadirla a la ruta de búsqueda de muestras. FoxDot buscará en todas sus rutas de búsqueda una muestra que coincida cuando le des un nombre.
