...
sn >> play(".(o[.o]o(oo[..oo]o))", sample=1, amp=1.3, room=1, rate=linvar([1,1.5],32))

hh >> play("[--]", sample=1, amp=1.3, room=1, rate=linvar([1,1.5],32)).eclipse(8,32,16)

Root.default = var([0,0,5,4,0,2,0,2],4)

b3 >> pluck([[1,_,2],0,[_,2],2], dur=P[.25,.5,.25,.25], oct=[4,5,6], amp=.7, lpf=linvar([600,2000],32))
