<script>
  ...
  import EditorSettings from '../browsers/EditorSettings.svelte';
    ...
    <div class="bg-base-300 p-2">
      <div class="flex justify-between items-center mb-2">
        <div class="tabs tabs-boxed">
          ...
          <button 
            class="tab {activeTab === 'editorSettings' ? 'tab-active' : ''}" 
            on:click={() => switchTab('editorSettings')}
          >
            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" viewBox="0 0 20 20" fill="currentColor">
    ...
    <div class="flex-1 overflow-y-auto p-4">
      ...
      {:else if activeTab === 'documentation'}
        <DocumentationViewer
          ...
          on:goHome
        />
      {:else if activeTab === 'editorSettings'}
        <EditorSettings
          on:settingsChanged
        />
      {/if}
