...
from renardo_lib.Settings import SC3_PLUGINS, FOXDOT_ROOT
...
SYNTHDEF_DIR_PATH = Path(FOXDOT_ROOT) / "osc" / "scsyndef"
synthdef_dir_empty = not any(SYNTHDEF_DIR_PATH.iterdir())

if synthdef_dir_empty:
    ...
    #               ]
    synths = [file_path.stem for file_path in SYNTHDEF_DIR_PATH.glob("*.scd")]
