from renardo_lib.SynthDefManagement.SimpleSynthDefs import SimpleSynthDef, LiveSynthDef, FileSynthDef
...
from .python_defined_synthdefs import (
    SC3_PLUGINS, arpy, bell, blip, bug, charm, creep, crunch, dab, dirt, donk, dub, feel, freq, fuzz, glass, gong, growl, instance,
