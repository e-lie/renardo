...
renardo - program to do something

# SYNOPSIS

**renardo** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**renardo** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **renardo** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**renardo** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    renardo. See **foo.conf**(5) for further details.
...
**renardo** provides some return codes, that can be used in scripts:
