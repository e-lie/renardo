...
FOXDOT_ICON  = os.path.realpath(FOXDOT_ROOT + "/img/icon.ico")
FOXDOT_ICON_GIF = os.path.realpath(FOXDOT_ROOT + "/img/icon.gif")
FOXDOT_HELLO = os.path.realpath(FOXDOT_ROOT + "/img/hello.txt")
...
FOXDOT_TEMP_FILE    = os.path.realpath(FOXDOT_ROOT + "/tmp/tempfile.txt")
...
try:
    ...
    from FoxDotEditor.Settings import conf
